...
class ArisenSwiftAbirixTests: XCTestCase {

    var abirix: ArisenAbirixSerializationProvider? = ArisenAbirixSerializationProvider()
    ...
    func testHexToJsonTransaction() {
        ...
        let json = """
        {"expiration":"2019-02-26T18:31:50.000","ref_block_num":40361,"ref_block_prefix":306112488,"max_net_usage_words":0,"max_cpu_usage_ms":0,"delay_sec":0,"context_free_actions":[],"actions":[{"account":"Arisen.token","name":"transfer","authorization":[{"actor":"cryptkeeper","permission":"active"}],"data":"00AEAA4AC15CFD4500000060D234CD3DA06806000000000004454F53000000001A746865206772617373686F70706572206C696573206865617679"}],"transaction_extensions":[]}
        """

        do {
            let result = try abirix?.deserializeTransaction(hex: hex)
    ...
    func testJsonToHexTransaction() {
        ...
        do {
            let resut = try abirix?.serializeTransaction(json: json)
